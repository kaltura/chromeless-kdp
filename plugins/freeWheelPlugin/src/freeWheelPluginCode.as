package
{
	...
	public class freeWheelPluginCode extends Sprite implements IPlugin, ISequencePlugin, IMidrollSequencePlugin
	{
		...
		private function configAm():void{
			...
			var duration:int = (this.mediaProxy.vo.entryDuration && this.mediaProxy.vo.entryDuration != int.MIN_VALUE) ? this.mediaProxy.vo.entryDuration : currentAssetDuration;
		...
		private function findAdUnit(cp:KalturaCuePoint):String 
		{
			...
			if (cp.startTime == mediaProxy.vo.entryDuration)
