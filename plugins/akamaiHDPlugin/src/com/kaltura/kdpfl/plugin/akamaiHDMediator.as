		...
		override public function handleNotification(notification:INotification):void
		{
			switch (notification.getName())
			{
				...
				case NotificationType.MEDIA_READY:
					...
					{
						if (_mediaProxy.vo.selectedFlavorIndex !=-1) 
						{
							akamaiMetadataValues += "&" + AkamaiStrings.AKAMAI_METADATA_KEY_MBR_STARTING_INDEX + "=" + _mediaProxy.vo.selectedFlavorIndex;
							_mediaProxy.notifyStartingIndexChanged(_mediaProxy.vo.selectedFlavorIndex);
						}
					}
