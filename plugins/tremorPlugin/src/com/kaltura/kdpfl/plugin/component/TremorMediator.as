		...
		override public function handleNotification(note:INotification):void {
			...
			switch (note.getName()) {
				case NotificationType.PLAYER_UPDATE_PLAYHEAD:
					if (_mediaProxy.vo.entryDuration && !_sequenceProxy.vo.isInSequence) {
						setPlayhead(data as Number, _mediaProxy.vo.entryDuration);
					}
					break;
				...
				case preSequenceNotificationStartName:
					...
					var newEntryId:String = _mediaProxy.vo.entryUrl;
					preAds(newEntryId);
					break;
