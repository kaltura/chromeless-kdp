package com.kaltura.kdpfl.view
{
	...
	public class RootMediator extends Mediator
	{
		 ...
		 * 
		 */		
		public function RootMediator(viewComponent:Object=null, mpSprite:MediaPlayerSprite = null)
		{
			_mediaPlayerSprite = mpSprite;
		...
		public function onResize( event : Event = null ):void
		{
			...
			if( _mediaPlayerSprite )
			{
				_mediaPlayerSprite.width = size.width;
				_mediaPlayerSprite.height = size.height;
			} 
